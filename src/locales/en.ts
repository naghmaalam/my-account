...
const en: Locale = {
  ...
  password_info_never_reuse:
    "The password must contain 6-100 character's. Password can include capital letters, small letters, numbers & symbols.",
  ...
  refer_friend_text:
    " Gift x days to which you invite, and collect more than a year of free Swoshs subscription for yourself!",
  check_our: "Check Our",
  ...
  account_settings_content:
    "_ Basic information on Data Protection: Swoshs VPN stores your data to improve the service and, with your consent, offers news, promotions and raffles, as well as version and releases from Swoshs VPN.",
  premium: "Premium",
